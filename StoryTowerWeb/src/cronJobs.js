...
} = require("./scraping/asuraCatalogScraper");
const {
  performAsuraChapterScraping,
} = require("./scraping/asuraChapterScraper");
...
async function cronJob() {
  cron.schedule("0 */12 * * *", async () => {
    ...
    try {
      ...
      console.log(
        "Asura catalog scraping and chapter scraping executed successfully."
      );
    } catch (error) {
      console.error(
        "Error executing Asura catalog scraping and chapter scraping:",
        error
      );
    } finally {
